     ...
     private function errors($type = null) {
         switch ($type) {
             case self::FILESIZE_EXCEED_SERVER_MAX:
                 return 'El archivo excede el tamaño maximo del servidor';
                 break;
             case self::FILESIZE_EXCEED_FORM_MAX:
                 return 'El archivo excede el tamaño maximo para subir';
                 break;
             case self::PARTIAL_UPLOAD:
                 return 'El archivo enviado no ha subido correctamente, verifique su conexións';
                 break;
             case self::NO_FILE_UPLOAD:
                 return 'No existe archivo.';
                 break;
             case self::NO_DIRECTORY_FOR_UPLOAD:
                 return 'El directorio para el archivo no existe';
                 break;
             case self::SERVER_WRITE_FAIL:
                 return 'No se pudo guardar en el servidor';
                 break;
             case self::FILE_FORMAT_NOT_ALLOWED:
              return 'El formato de archivo no es una imagen';
              break;
