...
class Usuario extends UsuariosAppModel {
	...
	public $validate = array(
		...
		'nombre' => array(
			...
			'alphanumeric' => array(
				'rule' => NOMBRESHISPANOS,
				'message' => 'Solo puede agregar letras',
				//'allowEmpty' => false,
				//'required' => false,
			),
		),
		...
		'direccion' => array(
			...
			'maxlength' => array(
				...
				'message' => 'Solo puede agregar 60 caracteres',
				//'allowEmpty' => false,
				//'required' => false,
			),
			'alphanumeric' => array(
				'rule' => ALFANUMERICRULE_SIMBOLO,
				'message' => "Solo puede agregar letras, número o (.,:()')",
				//'allowEmpty' => false,
				//'required' => false,
			),
		),
		'telefono' => array(
			'numeric' => array(
				'rule' => array('numeric'),
				'message' => 'Solo puede agregar número sin guiones',
				//'allowEmpty' => false,
				//'required' => false,
			),
		),
